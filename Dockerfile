...
COPY mavenHostedProxyCreateTemplate.json mavenHostedProxyCreateTemplate.json
COPY mavenHostedProxyUpdateTemplate.json mavenHostedProxyUpdateTemplate.json
COPY mavenProxyRepoCreate.sh mavenProxyRepoCreate.sh
COPY mavenProxyRepoUpdate.sh mavenProxyRepoUpdate.sh
COPY RepoDelete.sh RepoDelete.sh
